        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    AnswerStatusId = table.Column<int>(type: "integer", nullable: false),
                    Text = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: false),
                    CreatedDate = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "c7b013f0-5201-4317-abd8-c211f91b7330", "2", "Reviewer", "Reviewer" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "b74ddd14-6340-4840-95c2-db12554843e5", 0, "8cf618d1-9ae6-475e-8791-8badf12f99d4", "admin@example.com", true, false, null, "admin@example.com", "admin", "AQAAAAEAACcQAAAAEMuTng1EgJaSNjVSRClL6Rqpo9wOnkSmFtCHQitPIEgHcKKkqA6zxLuS1p3C1529dg==", "1234567890", false, "6d5e79c5-0bcd-4711-ad9b-91bc19ca4cf4", false, "Admin" });
